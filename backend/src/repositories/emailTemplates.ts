...
export type EmailTemplateKey = 'booking_confirmation' | 'booking_cancelled' | 'booking_rescheduled' | 'lesson_reminder' | 'invitation' | 'instructor_new_booking' | 'instructor_booking_cancelled' | 'instructor_lesson_reminder';
