  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-800">Platform overview and quick actions.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <SummaryCard title="🏫 Driving Schools" description="Total registered schools" footer={loading ? 'Loading...' : ''}>
          ...
          <p className="text-sm text-slate-800">{schools.filter(s => s.status === 'active').length} active</p>
        </SummaryCard>
        ...
        <SummaryCard title="📊 System Status" description="Platform health" footer="">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-slate-800">All systems operational</span>
          </div>
        </SummaryCard>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <SummaryCard title="📅 Today's Lessons" description="Scheduled for today" footer="">
          ...
          <p className="text-sm text-slate-800">{bookings.length} total upcoming</p>
        </SummaryCard>
      ...
      <SummaryCard title="⚡ Quick Actions" description="" footer="">
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/bookings" className="px-4 py-2 rounded bg-slate-100 text-slate-800 text-sm hover:bg-slate-200">
            View All Bookings
          </Link>
        </div>
      </SummaryCard>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-800">Your schedule overview.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <SummaryCard title="📆 This Week" description="Upcoming lessons" footer="">
          ...
          <p className="text-sm text-slate-800">total scheduled</p>
        </SummaryCard>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-800">Your learning progress and upcoming lessons.</p>
      </div>
          ...
          <div className="space-y-3">
            {allowedHours !== null ? (
              <>
                ...
                <p className="text-xs text-slate-800 text-center">of {allowedHours} total hours</p>
              </>
            ) : (
              <div className="text-center py-2">
                <p className="text-2xl font-bold text-blue-600">{usedHours.toFixed(1)} hrs</p>
                <p className="text-sm text-slate-800">used (no limit set)</p>
              </div>
            )}
          </div>
        </SummaryCard>
        ...
        <SummaryCard title="📅 Next Lesson" description="Your upcoming lesson" footer="">
          {nextLesson ? (
            ...
            <div className="text-center py-4">
              <p className="text-slate-800">No lessons scheduled</p>
      ...
      <SummaryCard title="⚡ Quick Actions" description="" footer="">
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/student" className="px-4 py-2 rounded bg-slate-100 text-slate-800 text-sm hover:bg-slate-200">
            Manage Addresses
          </Link>
        </div>
      </SummaryCard>
      ...
      <AppShell>
        ...
        {!role && (
          <div className="text-center py-10">
            <p className="text-slate-800">Please log in to see your dashboard.</p>
          </div>
        )}
      </AppShell>
    </Protected>
